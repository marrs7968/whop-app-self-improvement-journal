  ...
  return (
    <div className="w-full">
      ...
      <select
        ...
        disabled={disabled}
        className="w-full h-10 px-3 bg-zinc-800/90 border border-[#c6d4c7]/58 rounded-lg text-zinc-100 focus:outline-none focus:ring-2 focus:ring-[#9eb59f]/72 focus:border-[#c6d4c7]/82 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
      >
